...
<form action="/ServletTest/servlet/infoServlet" method="post">
	...
	お問い合わせ内容:<br><textarea name="info" rows="4" cols="40"  required="required"></textarea><br><br>
	メルマガ種類:<br>
	...
	資料請求希望:<br>
	Yes<input type="radio" name="radio" value="yes" checked="checked"><br>
